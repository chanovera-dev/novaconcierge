 ...
 *
 * Displays the archive listing of properties with left sidebar filters and interactive AJAX filtering.
 *
			...
			<div class="posts-grid properties--list" id="nc-properties-list-container">
				...
				?>
					<div class="no-properties-found" style="grid-column: 1 / -1; text-align: center; padding: 40px 20px; background: rgba(255,255,255,0.6); border-radius: 12px; margin: 20px 0;">
						<p style="font-size: 18px; color: #666;"><?php esc_html_e( 'No se encontraron propiedades publicadas.', 'novaconcierge' ); ?></p>
					</div>
				<?php
				endif;
				wp_reset_postdata();
